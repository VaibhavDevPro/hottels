		...
		<div class="form-part">
			<div class="d-flex justify-content-center">
				<div class="img py-xl-5 py-3">
					<img data-src="images/no-card-img.jpg" class="lazy" width="" height="" alt="">
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4  repeat-section">
						<div class="box">
							...
							<input type="text" class="form-control" id="full_name" name="full_name" value="Admin Kumar" placeholder="Full Name">
							</div>
					</div>
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 repeat-section">
						<div class="box">
							<label class="form-label">Card Number</label>
							<input type="text" class="form-control" id="full_name" name="full_name" value="8888 7777 7777 8888" placeholder="Email">
							</div>
					</div>
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 repeat-section">
						<div class="box mt-0">
							...
							<input type="text" class="form-control common-date" id="expiry_date" name="expiry_date" value="Expiry Date" placeholder="Expiry Date">
								<div class="icon">
					...
					<div class="col-12 mt-2">
						<div class="d-xl-flex">
							...
							<div class="image ps-xl-3 pt-xl-0 pt-3">
								<img data-src="images/all-payment-img.jpg" alt="" class="lazy" width="" height="" title="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="main-table">
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 mb-xl-0 mb-3">
						<div class="d-flex">
							<div class="img">
								<img data-src="images/small-card.jpg" alt="" class="lazy" width="" height="">
							</div>
							<div class="ps-3">
