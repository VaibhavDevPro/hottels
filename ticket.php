            ...
            <div class="page-content d-flex flex-column mt-4">
                        ...
                        <tr>
                            <td class="border-0 pt-18 pb-18">
                                <div class="d-flex align-items-center gap-1">
                                    ...
                                    <p class="fs-7 text-color-secondary mb-0 fw-semibold">1 Room</p>
                                </div>
                            </td>
                            <td colspan="2" class="border-0 pt-18 pb-18">
                                <div class="d-flex flex-column align-items-start">
                                    <p class="fs-7 text-color mb-0 fw-semibold">Standard AC Room</p>
                                    <p class="fs-9 text-color-secondary mb-0 fw-regular">Room With Free Breakfast</p>
                                    <p class="fs-9 text-color-secondary mb-0 fw-regular">(240 sq.ft | Swimming Pool View
                                        | Queen Bed)</p>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="border-custom rounded p-3 mb-4">
                    ...
                    <ul class="ps-3 mb-0 mt-2">
                        <li class="text-color-secondary fs-9 pl-2">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td class="border-0 pt-18 pb-18">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="box-18 circle-red">
                                        <span class="material-symbols-outlined text-white fs-7">
                                        cancel
                                    </div>
                                    <p class="fs-7 text-color-secondary mb-0 fw-semibold">Non-Refundable:</p>
                                </div>
                            </td>
                            <td colspan="2" class="border-0 pt-18 pb-18">
                                <p class="fs-8 text-color mb-0 fw-semibold">
